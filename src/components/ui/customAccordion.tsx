...
const AccordionItem: React.FC<AccordionItemProps> = ({
	...
	return (
		<div className="bg-white/90 dark:bg-black/90 rounded-xl shadow-lg border border-gray-200 dark:border-green-500/60 mb-4 overflow-hidden backdrop-blur-md relative">
			...
			<div className="absolute inset-0 bg-linear-to-br from-gray-50/50 to-white/30 dark:from-green-400/15 dark:to-green-500/10 rounded-xl pointer-events-none"></div>
