...
13. [Billing & Subscriptions](#billing--subscriptions)
14. [Data Import](#data-import)
...
export const bulkCreate = mutation({
  args: {
    clients: v.array(v.object({ /* client fields */ }))
  },
...
```typescript
// From schema.ts
usageTracking: v.optional(v.object({
...
Based on the current feature set, here are potential enhancements:

1. **Time Tracking**: Track time spent on projects/tasks
2. **Expense Tracking**: Log expenses against projects
3. **Reporting**: Advanced reporting and exports
4. **Mobile App**: Native mobile application
5. **SMS Notifications**: SMS reminders and updates
6. **Recurring Invoices**: Automatic recurring invoice generation
7. **Payment Plans**: Installment payment options
8. **Client Portal**: Full client portal with project visibility
9. **Team Chat**: Internal team communication
10. **File Sharing**: Enhanced file sharing between team and clients
11. **Custom Fields**: Custom fields for clients/projects/quotes
12. **Templates**: Quote and invoice templates
13. **Workflow Automation**: Automated workflows and triggers
14. **Integration APIs**: Third-party integrations (QuickBooks, etc.)
15. **Multi-Currency**: Support for multiple currencies
16. **Tax Management**: Advanced tax calculation and reporting
17. **Inventory Management**: Track inventory/equipment
18. **Route Optimization**: Optimize service routes
19. **Customer Portal**: Self-service client portal
20. **Advanced Permissions**: Granular permission system
