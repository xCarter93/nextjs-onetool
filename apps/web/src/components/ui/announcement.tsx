...
const Announcement = React.memo(
  ...
  `;
		...
		const variantClasses = {
			...
			gradient:
				"bg-linear-to-r from-cyan-400 to-blue-500 text-white border-0 hover:shadow-lg focus:ring-cyan-300 focus:ring-offset-gray-100 dark:from-cyan-600 dark:to-blue-700 dark:focus:ring-cyan-400 dark:focus:ring-offset-gray-900 dark:hover:shadow-blue-700/50",
		};
