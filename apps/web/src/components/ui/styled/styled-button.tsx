...
/**
 * StyledButton - A consistent button component with intent variants and sizes
 * Aligns with the unified styling system defined in /lib/styling.ts
 * 
 * Note: This component could be refactored to use stylingPatterns.buttonBase
 * and intentVariants from /lib/styling.ts in the future, but currently works
 * well with its own implementation for flexibility.
 */
